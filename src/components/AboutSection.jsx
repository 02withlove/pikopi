import { Leaf, ChefHat, Recycle } from 'lucide-react'

export default function AboutSection() {
  const features = [
    { Icon: Leaf,     title: 'Bahan Premium Lokal',    desc: 'Biji kopi dipilih langsung dari petani Aceh, Toraja, dan Flores.' },
    { Icon: ChefHat,  title: 'Barista Berpengalaman',  desc: 'Tim kami berlatih di World Barista Championship, siap menyajikan yang terbaik.' },
    { Icon: Recycle,  title: 'Ramah Lingkungan',       desc: 'Kemasan biodegradable & komitmen zero waste dalam operasional kami.' },
  ]
          ...
          <div className="col-lg-5">
            <div style={{ position: 'relative' }}>
              ...
              <div style={{
                ...
                padding: '1.5rem', color: 'var(--coffee-900)',
                width: 160, boxShadow: '0 8px 32px rgba(0,0,0,0.3)',
              }}>
