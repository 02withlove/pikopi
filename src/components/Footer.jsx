      ...
      <div className="container">
        <div className="row g-4">
          <div className="col-lg-4">
            <div className="footer-brand mb-2" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <span>☕</span> KOPI.KO
            </div>
            <p style={{ fontSize: '0.875rem', lineHeight: 1.8, maxWidth: 300 }}>
              Tempat di mana setiap cangkir adalah cerita. Hadir untuk menemani momen terbaikmu setiap hari.
            </p>
          ...
          <div className="col-lg-4">
            ...
            {[
              { Icon: MapPin, text: 'Jl. Kopi Aroma No. 17, Bandung' },
              { Icon: Phone,  text: '+62 812-3456-7890' },
              { Icon: Mail,   text: 'hello@kopiko.id' },
