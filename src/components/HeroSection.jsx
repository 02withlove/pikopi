        ...
        <div className="row align-items-center g-5">
          ...
          <div className="col-lg-6">
            ...
            <h1 className="hero-title">
              Rasa yang<br />
              <span className="accent">Berbicara</span><br />
              Sendiri.
            </h1>

            <p className="hero-desc">
              Setiap tegukan membawa cerita — dari biji kopi pilihan petani lokal,
              diseduh dengan penuh cinta untuk menemani harimu.
            </p>
